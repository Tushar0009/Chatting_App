          ...
          child: StreamBuilder(
            ...
            builder: (context, snapshot) {
              ...
              return ListTile(
                ...
                subtitle: Text(
                  _message != null? _message!.type == Type.image ?"image":_message!.msg: widget.userdata.about ,
                  maxLines: 1,
                ),
                trailing: _message == null ? null : 
                _message!.read.isEmpty && _message!.fromId != APIS.getUser.uid ?
                Container(
                ...
                Text(MyDateTime.getLastMessageDate(context : context , time:_message!.sent)),
              );
            },
          )),
    );
